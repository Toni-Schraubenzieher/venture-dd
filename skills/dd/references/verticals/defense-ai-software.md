...
- **Geschaeftsmodell-Taxonomie — Modell-Lizenz vs. Plattform vs. Systemlieferung:** Was genau wird verkauft? Modell-Lizenz (Weights + ggf. Serving-Infrastruktur) · Plattform/Workflow-Layer · Komplettsystem inkl. Hardware · Zulieferung in ein fremdes Systemprodukt. Die Antwort bestimmt Marge, Switching Cost und Substituierbarkeit **und weicht haeufig von der Deck-Darstellung ab** — Decks zeigen gern die Plattform, verkauft werden die Modelle
- **Selbsteinschaetzung gegenueber dem Wettbewerb:** Gruender direkt fragen, wie sie sich gegen konkret im selben Markt eingesetzte Systeme einordnen. Formulierungen wie *"on par"*, *"vergleichbar"*, *"anderer Ansatz"* sind wertvoller als jede Marketingaussage — und sie sind der schnellste Weg zur Unterscheidung von **Qualitaets- gegenueber Effizienzvorsprung**
- **Modul-Inventur mit Kunde und Reifegrad je Modul:** Pro benanntem Produkt/Modul: tatsaechliche Funktion, TRL, Kunde, Akkreditierungsstand — **und ob es im Deck ueberhaupt vorkommt**. Bei Multi-Modul-Anbietern ist das reifste Produkt erfahrungsgemaess nicht das am prominentesten beworbene
...
- [ ] **Modulbeschriftung Deck gegen muendliche Darstellung:** Jedes im Deck benannte Modul im Gespraech nach Funktion, TRL und Kunde abfragen. Abweichungen sind haeufig und selten Taeuschung — meist Komprimierung oder Mapping auf gaengige INT-Kategorien (HUMINT/ELINT/SIGINT), um anschlussfaehig zu wirken. **Materiell wird es, wenn das reifste Produkt im Deck fehlt** oder wenn TRL-Ziele Modulen zugeordnet sind, die etwas anderes tun. Konsequenz notieren: taugt das Deck als Grundlage einer Produktbewertung?
- [ ] **Evidenzklasse hinter "validated by / participated in":** Teilnahme an einem **Hackathon oder Innovationswettbewerb** eines Ministeriums ist eine Demonstration, keine Validierung und erst recht keine Beschaffung. Ebenso: Symposiums-Vortrag ≠ Forschungsauftrag, Messestand ≠ Kundenbeziehung. Pro Nennung die tatsaechliche Veranstaltung recherchieren und die Klasse bestimmen — sie sind oeffentlich meist gut auffindbar
- [ ] **Technologische Obsoleszenz des Kernprodukts:** Aendert sich die Umgebung so, dass der adressierte Anwendungsfall schrumpft? Beispiele: Verschluesselungsgrad gegnerischer Kommunikation steigt (entwertet COMINT-Transkription) · Frequenzsprungverfahren (erschwert Fingerprinting) · Post-Quantum-Migration · Wechsel zu Mesh- und Satellitenkommunikation. **Gegen die TRL-Verteilung stellen:** Wenn das reife Produkt einen schrumpfenden Markt bedient und der Nachfolger auf TRL 5-6 steht, kauft der Investor den Uebergang, nicht das Produkt
...
13. **Technologische Obsoleszenz des Kernprodukts:** Die Umgebung entwertet den adressierten Anwendungsfall schneller, als der Nachfolger reift. Besonders relevant bei SIGINT/COMINT, wo Verschluesselung, Frequenzmanagement und Kommunikationsarchitektur sich laufend gegen die eigene Faehigkeit entwickeln
14. **Effizienz- statt Qualitaetsvorsprung:** Der Vorteil liegt in Modellgroesse, Latenz oder Edge-Faehigkeit statt in der Erkennungsleistung. Real und verkaufbar — aber deutlich kuerzer haltbar als ein Daten- oder Zugangsvorsprung, weil Modellkompression branchenweit fortschreitet. Erkennbar daran, dass Gruender sich gegenueber Wettbewerbern als *"on par"* einordnen
15. **Cross-Border-Struktur:** Entitaeten, Personal oder IP-Ownership in Konfliktlaendern koennen westliche Beschaffung, Clearances und die Exit-Faehigkeit erschweren
...
- **Team-Signal:** mindestens eine Person mit echtem Beschaffungszugang (ex-Militaer, MOD/Behoerde, Prime) im Kernteam — nicht nur im Advisory Board. Kompensierbar durch Advisor **mit nachpruefbarer Identitaet**, Agenten auf Erfolgsbasis und Investoren mit Feldnetzwerk; ein nicht verifizierbarer Advisor-Claim zaehlt nicht
- **Oekosystem-Einbettung (UK als Beispiel):** aussagekraeftig sind Verbandsmitgliedschaft (ADS), extern auditierte Zertifizierungen (**Cyber Essentials Plus**, IASME, ISO 27001), Vortraege auf Forschungssymposien der Beschaffungsbehoerden (**DSTL/OFEME**), Praesenz auf Leitmessen (DSEI). Nicht aussagekraeftig: reine Lieferantenregistrierung (JOSCAR **registered**), Accelerator-Programme (NVIDIA Inception), Selbstassessments (Cyber Essentials Basic). **Die Grenze zwischen beiden Gruppen ist der externe Audit bzw. die Selektion**
- **Datenbeschaffung als Moat-Muster (Best Practice):** Der stabilste Aufbau ist **eigene Datenbeschaffung ueber Subunternehmer statt Nutzung von Kundendaten** — dann bleibt die IP beim Startup und dasselbe Modell ist mehrfach verkaufbar. Kundendaten-Training klingt naeher am Kunden, vernichtet aber regelmaessig das Weiterverkaufsrecht und damit die Skalierbarkeit des Modell-Lizenzgeschaefts. Pruefen, welchen Weg das Startup gewaehlt hat und ob es die Konsequenz kennt
